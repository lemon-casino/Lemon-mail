const en = {
    ...
    publicApiAdminDomain: 'API Standalone Admin Domain',
    publicApiAdminDomainDesc: 'When disabled, API-generated mailboxes under the administrator login domain are added to the admin account. When enabled, they are created as standalone users.',
    emailAccount: 'Email',
    account: 'Address',
    ...
    websiteTitle: 'Title',
    siteIcon: 'Site Icon',
    siteIconDesc: 'Super admin only. This icon is used for both the site logo and browser tab favicon. Supports PNG/JPG/WEBP/ICO/SVG and should be under 2MB.',
    siteIconTypeError: 'Please select an image file',
    siteIconSizeError: 'The icon file must be smaller than 2MB',
    delSiteIconConfirm: 'Are you sure you want to remove the current site icon?',
    ...
    prefixMode: 'Prefix Type',
    wordPrefix: 'Word Prefix',
    prefixGenerateFailed: 'Failed to generate an email prefix. Please try again.',
    atLeast: 'At Least',
    character: '',
    ...
    enableAddEmailAccess: 'Enable Add Email',
    disableAddEmailAccess: 'Disable Add Email',
    disableAllUserAddEmail: 'Disable Add Email For All Users',
    disableAllUserAddEmailConfirm: 'Are you sure you want to disable add-email access for all users except the super admin?',
    allMailboxGroup: 'All Mailboxes',
    storageTitle: 'Mailbox Storage',
    storageDialogIntro: 'You are managing mailbox storage for {scope}. Keep active addresses visible and release stored ones whenever needed.',
    visibleMailboxes: 'Visible Mailboxes',
    collectedMailboxes: 'Stored Mailboxes',
    storageVisibleDesc: 'Keep frequently used mailboxes here and collect the rest in batches.',
    storageCollectedDesc: 'Stored mailboxes are grouped by domain, and individual addresses can be released back out.',
    collectSelected: 'Collect Selected',
    collectByDomain: 'Collect Domain',
    collectMailbox: 'Collect',
    releaseMailbox: 'Release',
    storageEmptyVisible: 'No visible mailboxes are available to collect.',
    storageEmptyCollected: 'No mailboxes are currently stored.',
    storageAllCollected: 'All visible mailboxes are stored. Release the ones you need from storage.',
    storageOpenAction: 'Open Storage',
    accountRecoveryTitle: 'Recover Mailbox',
    accountRecoveryDesc: 'Deleted mailboxes are listed here. Restoring one returns it to the mailbox list and keeps its previous messages available.',
