const en = {
    ...
    siteIconDesc: 'The icon shown on the browser tab. Upload a local image (max 2MB) or provide an image URL',
    uploadIcon: 'Change Icon',
    restoreIcon: 'Restore Default',
    iconTooLarge: 'Icon file must be under 2MB',
    randomPrefixChars: 'Random Characters',
    randomPrefixWord: 'Random Word',
    randomPrefixCombo: 'Word Combo',
    excludeOwnDomain: 'Exclude Own Domain When Adding Emails',
    excludeOwnDomainDesc: 'When enabled, emails created from the web UI or via API cannot use the same domain as the login email (admin is exempt); when disabled, no restriction',
    noAvailableDomain: 'No available email domain',
