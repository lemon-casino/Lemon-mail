const zh = {
    ...
    addAccount: '添加邮箱',
    publicApiAdminDomain: 'API独立生成管理员域名',
    publicApiAdminDomainDesc: '关闭时，API 生成管理员登录域名邮箱会添加到管理员账号下；开启后，才会在用户列表中创建独立用户',
    emailAccount: '邮箱',
    account: '邮箱',
    userAccount: '用户邮箱',
    deleteUser: '删除账户',
    ...
    websiteTitle: '网站标题',
    siteIcon: '站点图标',
    siteIconDesc: '仅超级管理员可修改，将同时用于站点图标和浏览器标签页图标，支持 PNG/JPG/WEBP/ICO/SVG，建议小于 2MB。',
    siteIconTypeError: '请选择图片格式文件',
    siteIconSizeError: '图标文件不能超过 2MB',
    delSiteIconConfirm: '确定要删除当前站点图标吗？',
    ...
    prefixMode: '前缀类型',
    wordPrefix: '单词前缀',
    prefixGenerateFailed: '生成邮箱前缀失败，请重试',
    atLeast: '至少',
    character: '位',
    mustNotContain: '禁止包含',
    ...
    searchAccount: '搜索邮箱',
    accountTotal: '个邮箱',
    enableAddEmailAccess: '开启添加邮箱',
    disableAddEmailAccess: '关闭添加邮箱',
    disableAllUserAddEmail: '关闭全部用户加邮',
    disableAllUserAddEmailConfirm: '确定要关闭除超级管理员外所有用户的添加邮箱功能吗？',
    allMailboxGroup: '全部邮箱',
    storageTitle: '邮箱收纳',
    storageDialogIntro: '当前正在管理{scope}的邮箱收纳，可见邮箱保留在前台，已收纳邮箱可随时解放出来。',
    visibleMailboxes: '当前可见邮箱',
    collectedMailboxes: '已收纳邮箱',
    storageVisibleDesc: '常用邮箱保留在这里，支持多选后直接收纳。',
    storageCollectedDesc: '按域名查看已收纳邮箱，可将需要的邮箱单独解放出来。',
    collectSelected: '收纳已选邮箱',
    collectByDomain: '按域名收纳',
    collectMailbox: '收纳',
    releaseMailbox: '解放',
    storageEmptyVisible: '当前没有可收纳的可见邮箱',
    storageEmptyCollected: '当前没有已收纳邮箱',
    storageAllCollected: '当前可见区已清空，可从收纳中解放需要的邮箱。',
    storageOpenAction: '打开收纳',
    accountRecoveryTitle: '找回邮箱',
    accountRecoveryDesc: '这里会列出你删除过的邮箱。恢复后邮箱会重新回到邮箱列表，并继续接收和查看原来的邮件。',
