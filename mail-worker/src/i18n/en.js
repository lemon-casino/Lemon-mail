const en = {
	...
	addEmailDisabledForUser: 'This user is not allowed to add email addresses.',
	cannotModifyAdminAddEmail: 'The super admin add-email permission cannot be changed.',
	storageScopeInvalid: 'Invalid storage scope.',
	storageDomainInvalid: 'Invalid mailbox domain.',
	storageDomainNotFound: 'No mailbox under this domain was found for the current user.',
	storageNoAccountSelected: 'Please select at least one mailbox.',
	batchBan: 'Batch Ban',
