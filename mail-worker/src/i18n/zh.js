const zh = {
	...
	addEmailDisabledForUser: '当前用户已被禁止添加邮箱',
	cannotModifyAdminAddEmail: '不能修改超级管理员的添加邮箱权限',
	storageScopeInvalid: '收纳作用域不合法',
	storageDomainInvalid: '收纳域名不合法',
	storageDomainNotFound: '当前用户下不存在该域名邮箱',
	storageNoAccountSelected: '请选择要收纳的邮箱',
	batchBan: '批量封禁',
	batchEnable: '批量解封',
	batchRestore: '批量恢复',
